...
const EMPTY = {
  slug: '', code: '', nameAr: '', nameEn: '',
  descAr: '', descEn: '',
  branchAr: 'العلمي', branchEn: 'Scientific',
  morning: '', evening: '', morningRate: '', eveningRate: '',
  img: '', head: '', phone: '', email: '', location: '', status: 'active',
};
...
export default function AddDepartmentPage() {
  ...
  const handleUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const r = await fetch(`/api/upload?token=${token}&name=dept_${form.slug || Date.now()}`, { method: 'POST', body: fd });
  ...
  return (
    <div className="container-fluid">
      <div className="mb-3 d-flex justify-content-between align-items-center">
        <div><h1 className="h3 font-bold mb-1">{t('departments.add')}</h1><p className="text-muted text-sm mb-0">{t('departments.subtitle')}</p></div>
        ...
        <div className="row g-3">
          ...
          <div className="col-12">
            <div className="dashboard-card">
              ...
              <div className="dashboard-card-body">
                <div className="row g-3">
                  <div className="col-md-4"><label className="form-label text-xs text-muted">المعرف (slug) *</label><input className="form-control" value={form.slug} onChange={e => set('slug', e.target.value.toLowerCase().replace(/\s+/g, '-'))} placeholder="cybersecurity" /></div>
                  <div className="col-md-4"><label className="form-label text-xs text-muted">الكود</label><input className="form-control" value={form.code} onChange={e => set('code', e.target.value)} placeholder="CYB" /></div>
            ...
            <div className="dashboard-card">
              ...
              <div className="dashboard-card-body">
                ...
                <div className="mb-3"><label className="form-label text-xs text-muted">الفرع</label>
                  <select className="form-select" value={form.branchAr} onChange={e => set('branchAr', e.target.value)}>
            ...
            <div className="dashboard-card">
              ...
              <div className="dashboard-card-body">
                ...
                <div className="mb-3"><label className="form-label text-xs text-muted">Branch</label>
                  <select className="form-select" value={form.branchEn} onChange={e => set('branchEn', e.target.value)}>
